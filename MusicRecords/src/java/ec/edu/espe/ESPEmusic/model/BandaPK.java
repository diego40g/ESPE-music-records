 ...
 */
@Embeddable
public class BandaPK implements Serializable {
    ...
    public BandaPK(String codigoMusico, String codigoBanda) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof BandaPK)) {
            return false;
        }
        BandaPK other = (BandaPK) object;
